...
[ExecuteInEditMode]
[AddComponentMenu ("2DxFX/Standard/HealthBarController")]
[System.Serializable]
public class HealthBarController : MonoBehaviour
{
	[HideInInspector] public Material ForceMaterial;
	[HideInInspector] public bool ActiveChange=true;
	private string shader = "2DxFX/Standard/HealthBarController";
...
#if UNITY_EDITOR
[CustomEditor(typeof(HealthBarController)),CanEditMultipleObjects]
public class _2dxFX_EnergyBar_Editor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		HealthBarController _2dxScript = (HealthBarController)target;
